...
* @{
*/
#define PRODUCT_KEY "8613c5efa5c444d297503db38abb86ad"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "e0e2db49655745f6860042b5c6076751"
...
* @{
*/
#define Yaobi_BYTEOFFSET                    0
#define Yaobi_BITOFFSET                     0
#define Yaobi_LEN                           1
#define Y_qianjin_BYTEOFFSET                    0
#define Y_qianjin_BITOFFSET                     1
#define Y_qianjin_LEN                           1
#define Y_houtui_BYTEOFFSET                    0
#define Y_houtui_BITOFFSET                     2
#define Y_houtui_LEN                           1
#define Yeya_BYTEOFFSET                    0
#define Yeya_BITOFFSET                     3
#define Yeya_LEN                           1
#define X_qianjin_BYTEOFFSET                    0
#define X_qianjin_BITOFFSET                     4
#define X_qianjin_LEN                           1
#define X_houtui_BYTEOFFSET                    0
#define X_houtui_BITOFFSET                     5
#define X_houtui_LEN                           1
#define LED_ON_BYTEOFFSET                    0
#define LED_ON_BITOFFSET                     6
#define LED_ON_LEN                           1
#define LED_OFF_BYTEOFFSET                    0
#define LED_OFF_BITOFFSET                     7
#define LED_OFF_LEN                           1

#define Y_qianjin_value_RATIO                         1
#define Y_qianjin_value_ADDITION                      0
#define Y_qianjin_value_MIN                           0
#define Y_qianjin_value_MAX                           999
#define Y_houtui_value_RATIO                         1
#define Y_houtui_value_ADDITION                      0
#define Y_houtui_value_MIN                           0
#define Y_houtui_value_MAX                           999
#define X_qianjin_value_RATIO                         1
#define X_qianjin_value_ADDITION                      0
#define X_qianjin_value_MIN                           0
#define X_qianjin_value_MAX                           999
#define X_houtui_value_RATIO                         1
#define X_houtui_value_ADDITION                      0
#define X_houtui_value_MIN                           0
#define X_houtui_value_MAX                           999
/**@} */
...
typedef enum
{
  ...
  EVENT_LED_ON,
  EVENT_LED_OFF,
  EVENT_Y_qianjin_value,
  EVENT_Y_houtui_value,
  EVENT_X_qianjin_value,
  EVENT_X_houtui_value,
...
typedef struct {
  ...
  bool valueLED_ON;
  bool valueLED_OFF;
  uint32_t valueY_qianjin_value;
  uint32_t valueY_houtui_value;
  uint32_t valueX_qianjin_value;
  uint32_t valueX_houtui_value;
} dataPoint_t;
...
typedef struct {
  uint8_t flagYaobi:1;
  uint8_t flagY_qianjin:1;
  uint8_t flagY_houtui:1;
  uint8_t flagYeya:1;
  uint8_t flagX_qianjin:1;
  uint8_t flagX_houtui:1;
  uint8_t flagLED_ON:1;
  uint8_t flagLED_OFF:1;
  uint8_t flagY_qianjin_value:1;
  uint8_t flagY_houtui_value:1;
  uint8_t flagX_qianjin_value:1;
  uint8_t flagX_houtui_value:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valueY_qianjin_value;
  uint16_t valueY_houtui_value;
  uint16_t valueX_qianjin_value;
  uint16_t valueX_houtui_value;
} attrVals_t;
